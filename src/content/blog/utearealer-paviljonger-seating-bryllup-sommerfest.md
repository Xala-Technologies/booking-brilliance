...
Uteareal fungerer best når det brukes til deler av arrangementet, ikke hele. De vanligste kombinasjonene er:

- **Utendørs vielse, innendørs eller paviljong til middag.** Seremonien tar 20-30 minutter og tåler litt usikkert vær bedre enn en tre timer lang middag gjør.
- **Aperitiff og mingling ute, hovedfest i paviljong eller telt.** Gjestene flytter seg naturlig etter en time, noe som også gir dere en innebygd plan B hvis været snur mens festen pågår.
- **Hele sommerfesten ute i paviljong**, typisk for firmafester og runde dager med 30-80 gjester, der en skjermet paviljong med sider dekker hele kvelden uten behov for innendørs alternativ.

For bryllup med over 100 gjester anbefaler de fleste arrangementssteder en fast innendørs sal som hovedlokale, med paviljong eller uteareal som tillegg til aperitiff og fotografering, rett og slett fordi kapasitetsrisikoen ved dårlig vær blir for stor når hele gjestelisten skal sitte ute.

## Hva et godt uteareal til privat arrangement faktisk må dekke
...
1. **Søk på sted, dato og gjestetall.** Filtrer på hvilken type uteareal dere trenger, paviljong, telt eller åpen uteplass, og hvor mange gjester det skal romme.
2. **Sjekk kapasitet, strøm og underlag.** Se om detaljene stedet oppgir faktisk dekker det dere planlegger, ikke bare et generelt bilde av plassen.
3. **Se ledighet direkte i kalenderen.** En sanntidskalender viser om ønsket dato faktisk er ledig, i stedet for at dere venter på svar per e-post fra flere steder samtidig.
4. **Spør om plan B og skjenkebevilling** før dere legger inn forespørsel, slik at dere sammenligner steder på likt grunnlag.
5. **Bekreft og motta kvittering** med adresse, hva som er inkludert av møblering og utstyr, og vilkår for avbestilling ved dårlig vær.

I Digilist vises utearealer i samme sanntidskalender som resten av et arrangementssteds lokaler, med egen kapasitet, utstyrsliste og pris per uteplass, slik at dere ser ledighet for akkurat paviljongen eller uteplassen dere er interessert i, uten å måtte ringe for å få vite om den er opptatt.

## Sjekkliste før dere booker uteareal

- Er kapasiteten oppgitt for deres møblering, ikke stedets generelle maks
