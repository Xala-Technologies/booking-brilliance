...
keywords: ["utendørsfasiliteter", "booke grillhytte kommune", "leie paviljong kommune", "bålplass booking", "utendørsfasiliteter tilgjengelighet", "kommunale uteplasser leie"]
---
...
1. **Søk på sted og dato.** Filtrer på hvilket område eller friluftsområde fasiliteten skal ligge i, og hvilken dag eller kveld du trenger den.
2. **Sjekk kapasitet og utstyr.** Se antall sitteplasser, om det finnes fast grill eller bålpanne, og om det er toalett eller strøm på stedet.
3. **Velg tidspunkt.** Kalenderen viser ledige tider i sanntid, slik at du ser med en gang om fasiliteten er opptatt den kvelden du ønsker.
4. **Bekreft bookingen.** Som privatperson bekrefter du med ID-porten eller BankID, eller med vanlig innlogging der kommunen tillater det. Lag og foreninger kan bekrefte på vegne av organisasjonen.
5. **Motta bekreftelse.** Du får kvittering med adresse, eventuelle regler for bruk og rydding, og informasjon om hvordan du melder fra ved avbestilling.
...
## Kom i gang med booking av kommunens utendørsfasiliteter

En grillhytte som ikke er søkbar, er i praksis en fasilitet kommunen betaler for å vedlikeholde uten å få bruken igjen. Ved å legge de mindre, spesialiserte utendørsfasilitetene inn i samme bookingoversikt som idrettsanlegg og møterom, får innbyggerne et sted å finne dem, og kommunen får kontroll på hvem som bruker hva, når. Vil du se hvordan Digilist kan gjøre grillhytter, paviljonger og bålplasser like enkle å booke som resten av kommunens lokaler? [Book en demo](https://digilist.no/demo) med oss, så viser vi løsningen i praksis.
