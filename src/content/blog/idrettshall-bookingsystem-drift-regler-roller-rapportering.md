...
keywords: ["idrettshall booking", "bookingsystem idrettshall", "avbestilling no-show idrettshall", "roller bookingsystem", "rapportering utleie idrettshall", "dobbeltbooking idrettshall", "depositum idrettshall"]
---
...
| Rolle | Kan godkjenne | Kan endre pris | Kan kansellere |
|---|---|---|---|
| Bookingansvarlig | Ja | Nei | Ja, med begrunnelse |
| Saksbehandler | Ja, komplekse saker | Ja, innenfor regulativ | Ja |
| Driftsleder | Ja, alle | Ja | Ja |
| Vaktmester/anleggsdrift | Nei | Nei | Nei, kun varsel |
