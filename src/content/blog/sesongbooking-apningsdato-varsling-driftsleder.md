...
title: "Når åpner sesongbookingen i kommunen? Gjør datoen kjent"
description: "Hvorfor svaret på «når åpner sesongbookingen» i dag sitter hos én saksbehandler, og hva som skal til for at kommunen kan varsle søknadsvindu automatisk."
date: 2026-08-17
...
keywords: ["når åpner sesongbookingen kommune", "søknadsfrist idrettshall sesong", "tildeling sesongplass kriterier", "klagefrist avslag booking", "sesongbooking driftsleder"]
---
...
1. **Én kilde til sannheten for datoene**, ikke separate regneark hos idrett, kultur og eiendom som sjelden stemmer overens med hverandre.
2. **Et system som sender ut varsel automatisk** til alle registrerte lag når vinduet åpner, ikke bare til dem som står på en gammel e-postliste noen husket å oppdatere.
3. **En fast rutine for når neste sesongs datoer fastsettes**, gjerne før forrige sesongs klagefrist er ute, slik at datoene aldri blir en hastesak i siste liten.
