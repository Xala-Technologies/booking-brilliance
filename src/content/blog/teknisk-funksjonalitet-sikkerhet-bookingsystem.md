...
I Digilist logger innbyggere inn med BankID gjennom ID-porten, uten eget passord for tjenesten, og får en signert, verifisert identitet på hver handling som krever det, for eksempel når en leiekontrakt skal være rettsgyldig. Kommunens egne saksbehandlere og driftsledere autentiseres gjennom kommunens egen identitetsløsning, med rollestyrt tilgang tildelt automatisk ut fra den rollen de allerede har der, slik at ingen egen brukerdatabase med separate passord må driftes i bookingsystemet. Den fulle mekanikken bak innbyggerinnloggingen, inkludert eID-nivåer og hva som skjer når en bruker ikke har BankID, er beskrevet i [ID-porten og BankID: pålitelig innlogging i kommunale tjenester](/blogg/idporten-bankid-kommunal-innlogging), med phishing-motstand utdypet i [phishingresistente innlogginger med ID-porten og BankID](/blogg/phishing-resistente-innlogginger-idporten-bankid). Den tekniske integrasjonsflyten mot ID-porten og kommunens Microsoft 365-miljø, inkludert Outlook-kalendersync, er dokumentert i [ID-porten og BankID: slik sikrer Digilist bookingen din](/blogg/id-porten-bankid-integrasjon-kommune-booking).
