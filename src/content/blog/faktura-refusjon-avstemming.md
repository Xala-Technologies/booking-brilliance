...
For en bookingplattform er økonomimotoren den som skiller seriøse løsninger fra hobbyprosjekter. Det er enkelt å lage en booking. Det er vanskeligere å sørge for at hver booking blir til riktig faktura, hver kansellering til riktig refusjon, og at hver krone som beveger seg lander i kommunens regnskap med riktig kontokode.
...
Refusjoner er det enkleste å gjøre feil i et bookingsystem. Vi har fokusert på å gjøre det enkelt riktig.
...
Manuell overføring av tall fra bookingsystem til regnskap er ikke bare arbeid. Det er en feilkilde. Digilist sender data direkte til:
...
Det er ikke magisk. Det er disiplinert datamodellering, og det er forskjellen mellom et bookingsystem som passer til en matbutikk og et som tåler en kommune.
