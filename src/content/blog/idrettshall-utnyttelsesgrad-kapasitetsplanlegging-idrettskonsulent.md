...
title: "Idrettshall: fra driftslogg til beslutningsgrunnlag"
description: "Se hvordan sanntidsdata om ledige tider i idrettshallen gir idrettskonsulenten utnyttelsesgrad, rapportering til idrettsrådet og bedre grunnlag."
date: 2026-08-10
...
keywords: ["idrettshall ledige tider", "utnyttelsesgrad idrettshall", "sesongtildeling", "kapasitetsplanlegging idrettsanlegg", "bookingsystem idrettshall", "rapportering idrettsråd"]
---
...
1. **Dobbeltbooking** oppstår når to lag får samme tid, oftest fordi en endring i regnearket ikke ble oppdatert alle steder. Bookingsystemet forhindrer dette ved å låse tiden i det den bekreftes.
2. **Avbud** som ikke meldes tilbake til systemet, gjør at tiden fortsatt telles som brukt selv om hallen sto tom.
3. **No-show** er verst for datakvaliteten, fordi ingenting registreres. Tiden var tildelt, ingen møtte opp, og ingen sa fra.
