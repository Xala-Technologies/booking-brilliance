 ...
 * can take tens of ms (e.g. the ConvexScope chunk pulled in by /transparens
 * and /status measured ~75ms). A single `setTimeout(resolve, 0)` yields for
 * one tick, which isn't enough — the loop would exhaust its passes and
 * settle on the "Laster…" fallback, i.e. an effectively empty prerendered
 * page.
 */
