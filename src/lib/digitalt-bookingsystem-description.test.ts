 ...
 * A description over ~160 chars gets truncated by Google and other consumers (XAL-787).
 */
describe("digitalt-bookingsystem-hva-er-det meta description", () => {
  it("is under 160 characters", () => {
    const post = getAllPosts().find((p) => p.slug === "digitalt-bookingsystem-hva-er-det");
