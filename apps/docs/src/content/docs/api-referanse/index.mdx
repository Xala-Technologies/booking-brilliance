...
V1-dokumentasjonen her dekker public + admin. Platform-API-et er nå versjonert på `/api/v1/` — inkludert konto- og meldings-endepunkter for Digilist Mobile — med egen OpenAPI-kontrakt på `GET /api/v1/openapi.json`. Full endepunkt-referanse i denne seksjonen kommer senere.
