...
<HowdygoDemo
  caption="INTERAKTIV DEMO · COMPLIANCE"
  title="Samsvar i praksis — på 2 minutter"
  description="Se hvordan en kommune-IT-leder dokumenterer samsvar gjennom GDPR, ISO 27001, NSM grunnprinsipper og SSA-L 2026 bilag 7."
  duration="2 min"
  steps={[
    { num: "01", label: "Last ned DPA og sub-processor-liste" },
    { num: "02", label: "Kjør egen-vurdering mot bilag 7" },
    { num: "03", label: "Verifiser datalokasjon (EØS only)" },
    { num: "04", label: "Eksporter samsvarsmatrise som PDF" },
  ]}
/>
...
- **Sårbarhetsrapportering** — RFC 9116 `security.txt` publisert på [`/.well-known/security.txt`](https://digilist.no/.well-known/security.txt)
- **Automatisk hendelsesdeteksjon** — brute-force innlogging og avvik i betalingsbeløp varsler platform-admin i sanntid
